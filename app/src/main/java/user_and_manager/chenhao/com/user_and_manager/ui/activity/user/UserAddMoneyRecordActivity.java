...
public class UserAddMoneyRecordActivity extends BaseActivity
{
        ...
        public void handleMessage(Message msg)
        {
            ...
            if (msg.what == 200)
            {
                mListViewAdapter mListViewAdapter = new mListViewAdapter
                        (UserAddMoneyRecordActivity.this, logItems);
                                ...
                                .HttpPosttListenter()
                        {
                            ...
                            public void HttpPostResultListenter(int status, String result)
                            {
                                ...
                                if (status == 200)
                                {
                                    ...
                                    {
                                        if (item.type == 2 && BaseData.cur_carID.equals(item.cid
                                                + ""))
                                        {
                                            logItems.add(item);
                                        }
                                    ...
                                    Log.e("huaji", "HttpPostResultListenter: " + tempList
                                            .toString());
...
//            convertView.findViewById(R.id.item_line_imager);
            ...
            t1.setText(getTime(item.time) + "消费" + item.money + "元\n" + tempSrc);
            return convertView;
        }
    }
