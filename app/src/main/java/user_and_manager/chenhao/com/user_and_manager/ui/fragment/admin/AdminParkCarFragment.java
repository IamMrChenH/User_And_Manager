...
public class AdminParkCarFragment extends BaseFragment implements Runnable
{
    ...
    public AdminParkCarFragment()
    {
        // Required empty public constructor
    }

    public static AdminParkCarFragment newInstance(String param1, String param2)
    {
        AdminParkCarFragment fragment = new AdminParkCarFragment();
...
//                    showToast("预约车位成功！");
                    mService.submit(new Runnable()
                    {
                        ...
                        public void run()
                        {
                            ...
                            JasonUtils.put(newJason, "isPark", "1");
